...
export const MarqueSection = () => {
  return (
    <Reveal>
      <section className="px-4  dark:bg-black-100  z-[5] scroll-m-40">
        <div
          className={clsx(
        ...
        >
          ...
          <Reveal>
            <p className="dark:text-gray-200 text-black-100 mx-auto mb-12 lg:max-w-3xl max-w-5xl text-center text-base md:text-[1.125rem] md:leading-[1.5] text-slate-11 font-normal 2xl:max-w-3xl">
              Nos enorgullece contar con la confianza de una amplia gama de clientes que buscan
              proteger sus vehículos con un servicio de grabado de patentes seguro y efectivo.
            </p>
          </Reveal>
        </div>
        ...
        <Reveal>
          <div className="flex items-center justify-center flex-col mt-20">
            ...
            <p className="dark:text-gray-100  text-black-200 text-sm 2xl:text-[1.5rem] lg:text-[1.5rem] leading-[1.5] text-slate-12 font-medium text-center 2xl:max-w-3xl lg:max-w-[750px]">
              ...
              buscan proteger sus flotas, todos nuestros clientes valoran la calidad,
              profesionalismo y atención al detalle que ofrecemos..{" "}
            </p>
          </div>
        </Reveal>
      </section>
