...
export const ShieldSvg = () => {
  return (
    <div className="dark:bg-black-200  bg-gray-200 py-5 px-5 rounded-[44px] border-2 z-10">
      <svg className=" text-center items-center" xmlns="http://www.w3.org/2000/svg" width={100} height={100} viewBox="0 0 24 24">
