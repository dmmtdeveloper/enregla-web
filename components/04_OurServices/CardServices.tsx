    ...
    <Reveal>
      <div>
        <div className="flex w-full flex-col gap-3 md:gap-2">
          <div className="flex items-center gap-4 2xl:flex-col 2xl:items-start 2xl:gap-2 lg:flex-col">
          ...
          <p
            className={clsx("text-sm leading-[1.6] dark:text-slate-300 font-normal text-black-200")}
          >
            {content}
          </p>
        </div>
